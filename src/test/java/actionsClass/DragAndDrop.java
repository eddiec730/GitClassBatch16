...
public class DragAndDrop {
    ...
    public void DragAndDrop() throws InterruptedException {
        ...
        String expectedBackGroundColor="rgba(238, 111, 11, 1)"; // the one is alpha corrector
        ...
        orangeBox= driver.findElement(By.xpath("//div[@id='droptarget']//div[@class='test2']"));//reassigning
