...
public class Practice {
    ...
    public void practiceJSAlert(){
        ...
        alert1.dismiss();
        Assert.assertEquals(BrowserUtils.getText(message),"You pressed Cancel in confirmation popup"); // same message from output
        ...
        alert2.accept();
        Assert.assertEquals(BrowserUtils.getText(message),"You entered text Edward in propmt popup");
